  ...
  return <div className="flex flex-col justify-between p-16">
    <div className="flex flex-col space-y-4">
      <p>
        ...
        I&apos;ve worked as a full stack developer for two years for <ExternalLink href="https://encircleapp.com">Encircle</ExternalLink>, and can provide references from them.
